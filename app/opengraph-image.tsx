...
export const alt = "Code Art — веб-студия полного цикла";
export const size = {
  width: 1200,
  height: 630,
};
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 28 }}>
          ...
          >
            Разработка сайтов, CRM и AI-интеграций
          </div>
          <div
            style={{
              maxWidth: 840,
          ...
          >
            Корпоративные сайты, веб-приложения, UX/UI, автоматизация и поддержка цифровых продуктов.
          </div>
        </div>
